...
ggplot(tile_data_set,aes(x=Region,y=Genre,fill=total_rev)) + geom_() + scale_fill_gradient(low="white",high="blue") +
#        scale_x_discrete(guide=guide_axis(angle=60)) +
#        labs(y="Product",x="Location",title="Warehouse Product Distribution",fill="Amount")
```
